...
-- ============================================================
INSERT IGNORE INTO t_product_category (category_id, category_name, parent_id, sort_order, status) VALUES
(1,  '电子元器件', NULL, 1, 1),
(2,  '机械零件',   NULL, 2, 1),
(3,  '化工材料',   NULL, 3, 1),
(4,  '包装材料',   NULL, 4, 1),
...
-- 2. 库位信息 (3个库区, 每个8个库位)
-- ============================================================
INSERT IGNORE INTO t_warehouse_location (location_id, location_code, location_name, zone, status) VALUES
-- A区 - 原材料区
...
-- ============================================================
-- 2-扩展. 库位扩展 (新增44个库位, 总计68个)
--   - A/B/C 区各新增 8 个 (3-4排)
--   - 新增 D区-退货区(8个) / E区-冷藏区(4个) / F区-危险品区(4个) / G区-暂存区(4个)
--   幂等保护: 重跑脚本时先清除 ID 25-68 的库位
-- ============================================================
DELETE FROM t_warehouse_location WHERE location_id BETWEEN 25 AND 68;

INSERT INTO t_warehouse_location (location_id, location_code, location_name, zone, status) VALUES
-- A区 - 原材料区 扩展 (8个: A-03-01 ~ A-04-04)
(25, 'A-03-01', '原材料货架A03-01', 'A区-原材料', 1),
(26, 'A-03-02', '原材料货架A03-02', 'A区-原材料', 1),
(27, 'A-03-03', '原材料货架A03-03', 'A区-原材料', 1),
(28, 'A-03-04', '原材料货架A03-04', 'A区-原材料', 1),
(29, 'A-04-01', '原材料货架A04-01', 'A区-原材料', 1),
(30, 'A-04-02', '原材料货架A04-02', 'A区-原材料', 1),
(31, 'A-04-03', '原材料货架A04-03', 'A区-原材料', 1),
(32, 'A-04-04', '原材料货架A04-04', 'A区-原材料', 1),
-- B区 - 半成品区 扩展
(33, 'B-03-01', '半成品货架B03-01', 'B区-半成品', 1),
(34, 'B-03-02', '半成品货架B03-02', 'B区-半成品', 1),
(35, 'B-03-03', '半成品货架B03-03', 'B区-半成品', 1),
(36, 'B-03-04', '半成品货架B03-04', 'B区-半成品', 1),
(37, 'B-04-01', '半成品货架B04-01', 'B区-半成品', 1),
(38, 'B-04-02', '半成品货架B04-02', 'B区-半成品', 1),
(39, 'B-04-03', '半成品货架B04-03', 'B区-半成品', 1),
(40, 'B-04-04', '半成品货架B04-04', 'B区-半成品', 1),
-- C区 - 成品区 扩展
(41, 'C-03-01', '成品货架C03-01', 'C区-成品', 1),
(42, 'C-03-02', '成品货架C03-02', 'C区-成品', 1),
(43, 'C-03-03', '成品货架C03-03', 'C区-成品', 1),
(44, 'C-03-04', '成品货架C03-04', 'C区-成品', 1),
(45, 'C-04-01', '成品货架C04-01', 'C区-成品', 1),
(46, 'C-04-02', '成品货架C04-02', 'C区-成品', 1),
(47, 'C-04-03', '成品货架C04-03', 'C区-成品', 1),
(48, 'C-04-04', '成品货架C04-04', 'C区-成品', 1),
-- D区 - 退货区 (8个)
(49, 'D-01-01', '退货暂存D01-01', 'D区-退货区', 1),
(50, 'D-01-02', '退货暂存D01-02', 'D区-退货区', 1),
(51, 'D-01-03', '退货暂存D01-03', 'D区-退货区', 1),
(52, 'D-01-04', '退货暂存D01-04', 'D区-退货区', 1),
(53, 'D-02-01', '退货暂存D02-01', 'D区-退货区', 1),
(54, 'D-02-02', '退货暂存D02-02', 'D区-退货区', 1),
(55, 'D-02-03', '退货暂存D02-03', 'D区-退货区', 1),
(56, 'D-02-04', '退货暂存D02-04', 'D区-退货区', 1),
-- E区 - 冷藏区 (4个)
(57, 'E-01-01', '冷藏柜E01-01', 'E区-冷藏区', 1),
(58, 'E-01-02', '冷藏柜E01-02', 'E区-冷藏区', 1),
(59, 'E-01-03', '冷藏柜E01-03', 'E区-冷藏区', 1),
(60, 'E-01-04', '冷藏柜E01-04', 'E区-冷藏区', 1),
-- F区 - 危险品区 (4个)
(61, 'F-01-01', '危化品柜F01-01', 'F区-危险品区', 1),
(62, 'F-01-02', '危化品柜F01-02', 'F区-危险品区', 1),
(63, 'F-01-03', '危化品柜F01-03', 'F区-危险品区', 1),
(64, 'F-01-04', '危化品柜F01-04', 'F区-危险品区', 1),
-- G区 - 暂存区 (4个)
(65, 'G-01-01', '暂存货架G01-01', 'G区-暂存区', 1),
(66, 'G-01-02', '暂存货架G01-02', 'G区-暂存区', 1),
(67, 'G-01-03', '暂存货架G01-03', 'G区-暂存区', 1),
(68, 'G-01-04', '暂存货架G01-04', 'G区-暂存区', 1);

-- 演示"库位管理-禁用"功能: 禁用 C 区 2 个新库位
UPDATE t_warehouse_location SET status = 0 WHERE location_id IN (45, 46);

-- ============================================================
-- 3. 产品信息 (20个产品, 覆盖所有类别)
-- ============================================================
INSERT IGNORE INTO t_product (product_id, product_code, product_name, category_id, unit, spec, upper_limit, lower_limit, default_location_id, status) VALUES
-- 电子元器件
...
--    BCrypt(10轮): test123
-- ============================================================
INSERT IGNORE INTO t_user (user_id, username, password, real_name, phone, email, status) VALUES
...
-- 5. 库存台账 (初始化各产品的库存)
-- ============================================================
INSERT IGNORE INTO t_stock (product_id, location_id, quantity, create_by) VALUES
-- 电子元器件在A区
(1,  1,  3200.00, 2),
(2,  2,  1800.00, 2),
(3,  3,  45000.00, 2),
...
-- ============================================================
-- 5-扩展. 新增库位库存 (26条, 覆盖 A/B 区扩展 + D/E/F 特色库区)
--   幂等保护: 重跑脚本时先清除 ID 25-68 的库存
-- ============================================================
DELETE FROM t_stock WHERE location_id BETWEEN 25 AND 68;

INSERT INTO t_stock (product_id, location_id, quantity, create_by) VALUES
-- A区扩展 (8条) - 补充原材料
(5,  25, 1800.00, 2),   -- USB连接器
(6,  26, 950.00, 2),    -- 排针
(7,  27, 8500.00, 2),   -- M3螺丝
(8,  28, 6000.00, 2),   -- M4螺丝
(9,  29, 650.00, 2),    -- 6205轴承
(10, 30, 420.00, 2),    -- LM8UU轴承
(11, 31, 4200.00, 2),   -- O型圈
(12, 32, 1400.00, 2),   -- 油封
-- B区扩展 (8条) - 化工/包装
(13, 33, 750.00, 2),    -- 环氧树脂
(14, 34, 1400.00, 2),   -- 502胶
(15, 35, 260.00, 2),    -- 润滑脂
(16, 36, 290.00, 2),    -- 乙醇
(17, 37, 200.00, 2),    -- 异丙醇
(18, 38, 1600.00, 2),   -- 瓦楞纸箱
(19, 39, 3000.00, 2),   -- 防静电袋
(20, 40, 160.00, 2),    -- PET标签
-- D区-退货区 (5条)
(5,  49, 50.00, 2),     -- USB退库
(8,  50, 30.00, 2),     -- M4螺丝退库
(13, 51, 20.00, 2),     -- 环氧树脂退库
(15, 52, 5.00, 2),      -- 润滑脂退库
(19, 53, 100.00, 2),    -- 防静电袋退库
-- E区-冷藏区 (2条)
(16, 57, 150.00, 2),    -- 乙醇冷藏
(17, 58, 80.00, 2),     -- 异丙醇冷藏
-- F区-危险品区 (3条)
(13, 61, 50.00, 2),     -- 环氧树脂危化
(14, 62, 80.00, 2),     -- 502胶危化
(16, 63, 30.00, 2);     -- 乙醇危化
...
-- ============================================================
INSERT IGNORE INTO t_inbound_order (order_id, order_no, supplier_id, operator_id, confirm_operator_id, order_time, confirm_time, status, remark) VALUES
...
-- 入库单1明细: 电子料
INSERT IGNORE INTO t_inbound_order_detail (order_id, product_id, quantity, unit_price, location_id) VALUES
(1, 1,  1000.00, 28.50, 1),
(1, 2,  500.00,  12.00, 2),
(1, 3,  20000.00, 0.02, 3),
(1, 4,  20000.00, 0.05, 3),
...
-- ============================================================
INSERT IGNORE INTO t_outbound_order (order_id, order_no, customer_id, department, applicant, operator_id, confirm_operator_id, order_time, confirm_time, status, remark) VALUES
...
-- 出库单1明细
INSERT IGNORE INTO t_outbound_order_detail (order_id, product_id, quantity, unit_price, location_id) VALUES
(1, 1,  200.00,  30.00, 1),
(1, 3,  5000.00, 0.03, 3),
(1, 4,  3000.00, 0.06, 3),
(1, 5,  500.00,  3.50,  4),
...
-- ============================================================
INSERT IGNORE INTO t_borrow_record (record_id, record_no, product_id, quantity, borrower, borrow_date, expected_return_date, actual_return_date, return_quantity, operator_id, status, remark) VALUES
...
-- ============================================================
INSERT IGNORE INTO t_inventory_check (check_id, check_no, product_id, book_quantity, actual_quantity, diff_quantity, operator_id, check_date, status, remark) VALUES
...
-- 10. 操作日志 (示例日志，按时间降序)
-- ============================================================
INSERT IGNORE INTO t_operation_log (user_id, username, operation, module, request_method, request_url, request_params, response_result, execution_time, ip_address, status, operate_time) VALUES
...
UNION ALL SELECT '  └ A区-原材料:', COUNT(*) FROM t_warehouse_location WHERE zone='A区-原材料'
UNION ALL SELECT '  └ B区-半成品:', COUNT(*) FROM t_warehouse_location WHERE zone='B区-半成品'
UNION ALL SELECT '  └ C区-成品:',   COUNT(*) FROM t_warehouse_location WHERE zone='C区-成品'
UNION ALL SELECT '  └ D区-退货区:', COUNT(*) FROM t_warehouse_location WHERE zone='D区-退货区'
UNION ALL SELECT '  └ E区-冷藏区:', COUNT(*) FROM t_warehouse_location WHERE zone='E区-冷藏区'
UNION ALL SELECT '  └ F区-危险品:', COUNT(*) FROM t_warehouse_location WHERE zone='F区-危险品区'
UNION ALL SELECT '  └ G区-暂存区:', COUNT(*) FROM t_warehouse_location WHERE zone='G区-暂存区'
UNION ALL SELECT '  └ 已禁用库位:', COUNT(*) FROM t_warehouse_location WHERE status=0
...
UNION ALL SELECT '  └ 新增库位库存:', COUNT(*) FROM t_stock WHERE location_id BETWEEN 25 AND 68
